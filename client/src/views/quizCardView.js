...
export const renderQuizCard = async (
  ...
  if (currentStage === 3 || currentStage === 4) {
    containerHeader.textContent = `Stage ${currentStage + 1}. You are able to choose one of two answers.`;
  } else if (currentStage > 4 || currentStage < 8) {
    containerHeader.textContent = `Stage ${currentStage + 1}. You are able to choose one of four answers.`;
  }
