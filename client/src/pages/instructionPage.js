...
export const instructionPage = () => {
  ...
  instructionTitle.textContent =
    'You learn words in sets of 10 words. Each word goes through 8 stages of memorisation.';
  ...
  instructionStage_1_3_Title.textContent =
    'Stages 1-3 (Get to Know → Repeat → Remember)';
  ...
  stage2.textContent =
    'Stage 2: Fixing the pattern (Dutch again → English version)';
  ...
  instructionStage_4_8_Title.textContent =
    "Stages 4-8 (Test your knowledge — it's important to answer correctly!)";
  ...
  mistake01.textContent =
    'Learned (0-1 mistakes) - the word is considered memorised, not repeated.';
  ...
  mistake45.textContent =
    'Difficult (4-5 mistakes) - the word will start again, from step 1.';
  mistakeExplain.appendChild(mistake45);

  const resume = document.createElement('p');
  resume.classList.add('text-left');
  resume.textContent =
    'This approach helps to really memorise words - not just to see them once, but to learn them for a long time.';
